...
class IndexerService:
    ...
    async def index_chunks(self, kb_id: str, doc_id: str, user_id: str,
                           ...
                           dim: int) -> int:
        """批量索引文本块（图片信息已在 chunk.metadata 中）"""
        ...
        for i, (chunk, embedding) in enumerate(zip(chunks, embeddings)):
            ...
            if image_info:
                images = [{
                    "url": image_url,
                    "path": image_path,
                    "caption": chunk.content,  # image chunk 的 content 就是 caption
                }]
            ...
            operations.append({
                ...
                "image_url": image_url,
                "image_caption": chunk.content if chunk.chunk_type == "image" else "",
                "images": images,
